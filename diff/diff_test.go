...
func TestDiff(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			Changelog{
				Change{Type: CREATE, Path: []string{"set", "3"}, From: nil, To: struct{}{}},
			},
			nil,
		},
		{
			...
			Changelog{
				Change{Type: DELETE, Path: []string{"set", "3"}, From: struct{}{}, To: nil},
			},
			nil,
		},
		{
			...
			Changelog{
				Change{Type: CREATE, Path: []string{"set", "3"}, From: nil, To: nil},
			},
			nil,
		},
		{
...
func (o *testTypeDiffer) Diff(dt DiffType, df DiffFunc, cl *Changelog, path []string, a, b reflect.Value, parent interface{}) error {
...
func (o *testStringInterceptorDiffer) Diff(dt DiffType, df DiffFunc, cl *Changelog, path []string, a, b reflect.Value, parent interface{}) error {
	if dt.String() == "STRING" {
		// intercept the data
...
func (o *recursiveTestStructDiffer) Diff(dt DiffType, df DiffFunc, cl *Changelog, path []string, a, b reflect.Value, parent interface{}) error {
