...
func ExampleDiff() {
	...
	// Produces: Changelog{Change{Type:"update", Path:[]string{"id"}, From:1, To:2}, Change{Type:"update", Path:[]string{"name"}, From:"Green Apple", To:"Red Apple"}, Change{Type:"create", Path:[]string{"nutrients", "2"}, From:interface {}(nil), To:"vitamin e"}, Change{Type:"create", Path:[]string{"tags", "popularity"}, From:interface {}(nil), To:main.Tag{Name:"popularity", Value:"high"}}}
}
...
func ExampleFilter() {
	...
	fmt.Printf("%#v", changelog)
	// Output: Changelog{Change{Type:"update", Path:[]string{"id"}, From:1, To:2, parent:diff_test.Fruit{ID:1, Name:"Green Apple", Healthy:true, Nutrients:[]string{"vitamin c", "vitamin d"}, Tags:[]diff_test.Tag(nil)}}, Change{Type:"create", Path:[]string{"nutrients", "2"}, From:interface {}(nil), To:"vitamin e", parent:interface {}(nil)}}
}
...
func ExamplePrivatePtr() {
	...
	fmt.Printf("%#v", changelog)
	// Output: Changelog{Change{Type:"update", Path:[]string{"value"}, From:interface {}(nil), To:111, parent:diff_test.number{value:(*big.Int)(nil), exp:0}}}
}
